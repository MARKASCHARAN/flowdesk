...
router.post('/ticket/:ticketId', validate(commentsValidation.createComment), commentsController.createComment);
router.get('/ticket/:ticketId', validate(commentsValidation.listQuery), commentsController.getComments);

// And generic update/delete routes:
// PATCH /api/v1/comments/:id
// DELETE /api/v1/comments/:id
router.patch('/:id', validate(commentsValidation.updateComment), commentsController.updateComment);
router.delete('/:id', validate(commentsValidation.paramId), commentsController.deleteComment);
